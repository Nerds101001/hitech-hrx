  ...
  <div class="col-xl-8">
    <div class="row g-6">
      ...
      <div class="col-12 animate__animated animate__fadeIn">
        <div class="hitech-card shadow-sm border-start border-4 mb-6" style="border-left-color: #0d9488 !important;">
            ...
            <div class="table-responsive">
              <table class="table table-hover table-borderless align-middle mb-0">
                <thead class="table-light">
                  <tr>
                    <th style="font-size:0.75rem; text-transform:uppercase; letter-spacing:0.05em; font-weight:700; padding-left: 1.5rem;">Client / Contact</th>
                    ...
                    <th class="text-end" style="font-size:0.75rem; text-transform:uppercase; letter-spacing:0.05em; font-weight:700; padding-right: 1.5rem;">Actions</th>
                  </tr>
                </thead>
                <tbody>
