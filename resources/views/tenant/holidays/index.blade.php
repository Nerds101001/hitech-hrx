...
<div class="layout-full-width animate__animated animate__fadeIn">
  ...
  <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-6 mx-4 py-2">
    <h3 class="fw-extrabold mb-0 text-dark">Holiday Management</h3>
    <button type="button" class="btn btn-hitech-primary shadow-sm px-5 add-new" data-bs-toggle="modal" data-bs-target="#modalAddOrUpdateHoliday">
      <i class="bx bx-plus-circle me-1"></i>Add New Holiday
    </button>
  </div>
      ...
      <div class="card-body p-sm-5 p-4">
        <div class="d-flex flex-wrap align-items-center gap-3">
          ...
          <div class="d-flex align-items-center gap-3">
            ...
            <button type="button" class="btn btn-hitech-primary px-4 shadow-sm" id="btnExportHolidays">
              <i class="bx bx-export fs-5"></i>
              <span>EXPORT</span>
            </button>

            <div class="d-flex align-items-center gap-2 ms-2">
              <span class="badge bg-label-hitech rounded-pill px-3 py-2 fw-bold small">
  ...
  <div class="px-4">
    <div class="hitech-card-white p-0 overflow-hidden">
      <div class="card-datatable table-responsive">
        <table class="datatables-holidays table m-0 shadow-none border-top">
          <thead>
            <tr>
              <th>@lang('')</th>
              <th>@lang('Id')</th>
