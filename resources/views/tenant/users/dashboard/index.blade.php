...
@section('title', 'Admin System Control')
...
<div class="row g-6">
  ...
  <div class="col-lg-12">
    <div class="admin-hero animate__animated animate__fadeIn">
      ...
      <div class="d-none d-md-block text-end" style="max-width: 400px; position:relative; z-index:1;">
        <small class="text-white italic opacity-75">"{{$quoteText}}"</small>
      </div>
    </div>
  </div>
  ...
  <!-- Middle Row: Charts & Pending -->
  <div class="col-xl-8">
    <div class="row g-6">
      <!-- Time Spending/Weekly Report -->
      <!-- Time Spending/Weekly Report -->
      <div class="col-12">
          ...
          <div class="card-body">
            <div class="row align-items-center">
              <div class="col-md-4 text-center text-md-start">
                <h2 class="mb-1" style="color:#005a5a;">{{ $thisWeekWorkingHours }}h</h2>
                  ...
                  <tr>
                    <td>
                      <div class="d-flex align-items-center">
                        ...
                        <span class="fw-bold text-dark">{{ $request->user->full_name }}</span>
                      </div>
                    </td>
