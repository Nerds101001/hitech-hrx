...
@php
    ...
    function getMetric($desc) {
        if (preg_match('/Metric:\s*(.*?)\n/', $desc, $matches)) return $matches[1];
        if (preg_match('/Metric:\s*(.*?)($|\|)/', $desc, $matches)) return $matches[1];
...
<div class="">
    <div class="animate__animated animate__fadeIn">
        ...
        <div>
            <a href="{{ route('employees.index') }}" class="btn btn-hitech rounded-pill px-4 d-flex align-items-center">
    ...
    <div class="row">
                ...
                <div class="card-body pt-4">
                    <div class="user-avatar-section text-center position-relative mb-4">
                        ...
                        <div class="mt-2 text-center">
                            ...
                            @else
                                <span class="badge rounded-pill px-4 py-2 fw-bold" style="background-color: #FEF3C7; color: #D97706; font-size: 0.65rem; letter-spacing: 0.5px;">{{ strtoupper($user->status->value) }}</span>
                            @endif
                        </div>
                    ...
                    <div class="border-top pt-4">
                        <ul class="list-unstyled mb-0 fs-6" style="color: #475569;">
                            ...
                            <li class="mb-3 d-flex align-items-center">
                                ...
                                <span class="fw-bold">Biometric ID:</span>&nbsp;{{ $user->biometric_id ?? 'Not Mapped' }}
                            </li>
                            <li class="mb-3 d-flex align-items-center">
                            ...
                            <li class="mb-3 d-flex align-items-start">
                                ...
                                <div class="flex-column">
                                    <small class="text-muted d-block text-uppercase fw-extrabold" style="font-size: 0.65rem; letter-spacing: 0.5px;">Date of Birth</small>
                                    <span class="text-dark fw-bold">{{ $user->dob ? \Carbon\Carbon::parse($user->dob)->format('d M Y') : 'N/A' }}</span>
                                    @if($user->dob)
                                        <span class="badge badge-hitech-success ms-1" style="font-size: 0.6rem; padding: 2px 6px;">{{ \Carbon\Carbon::parse($user->dob)->age }} YRS</span>
                                    @endif
                                </div>
                            </li>
                            <li class="mb-3 d-flex align-items-start">
                                ...
                                <div class="flex-column">
                                    <small class="text-muted d-block text-uppercase fw-extrabold" style="font-size: 0.65rem; letter-spacing: 0.5px;">Join Date</small>
                                    <span class="text-dark fw-bold">{{ $user->date_of_joining ? \Carbon\Carbon::parse($user->date_of_joining)->format('d M Y') : 'N/A' }}</span>
                                </div>
                            </li>
                            ...
                            <li class="mb-3 d-flex align-items-center">
                                ...
                                <span class="badge" style="background-color: #E0F2F1; color: #127464; font-size: 0.7rem;">{{ $user->leavePolicyProfile?->name ?? 'No Policy' }}</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    @else
                        ...
                        <div class="p-3 rounded-3 mb-4 border" style="background: rgba(18, 116, 100, 0.03); border-color: rgba(18, 116, 100, 0.1) !important;">
                             <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div class="hitech-toggle-wrapper">
                                    <input type="checkbox" id="employeeStatusToggle" class="hitech-switch-input" 
                        ...
                        @if ($user->status == \App\Enums\UserAccountStatus::ONBOARDING_SUBMITTED || $user->status == \App\Enums\UserAccountStatus::ONBOARDING_REQUESTED)
                            ...
                            <div class="d-flex gap-2 mb-4">
                                ...
                                <button type="button" class="btn btn-sm flex-fill rounded-pill fw-bold text-white shadow-sm" style="background-color: #f97316; border-color: #ea580c;" data-bs-toggle="modal" data-bs-target="#modalReviewOnboarding">
        ...
        <div class="col-xl-9 col-lg-9 col-md-8 col-12">
            <style>
                ...
                .rosemary-tab-arrow.left { left: 8px; }
                .rosemary-tab-arrow.right { right: 8px; }
                .rosemary-nav-tabs {
                    display: flex;
            ...
            <div class="rosemary-nav-tabs-wrapper mb-4">
                ...
                <ul class="nav nav-pills border-0 flex-column flex-md-row rosemary-nav-tabs" id="employeeTabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" href="#employment-assets"><i class="bx bx-briefcase me-1"></i> Employment & Assets</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" href="#banking-payroll"><i class="bx bx-credit-card me-1"></i> Banking & Payroll</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" href="#documents"><i class="bx bx-file me-1"></i> Documents</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" href="#tasks-tab"><i class="bx bx-bullseye me-1"></i> Key Result Areas (KRAs)</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" href="#kpi"><i class="bx bx-bar-chart-alt-2 me-1"></i> Strategic KPIs</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" href="#activity"><i class="bx bx-history me-1"></i> Activity Logs</a>
                    </li>
                </ul>
                    ...
                    <div class="card mb-4 emp-card border-0">
                        <div class="card-body p-5">
                            <div class="d-flex justify-content-between align-items-center mb-5">
                                ...
                                <button class="btn btn-hitech px-4 rounded-pill shadow-sm" data-bs-toggle="modal" data-bs-target="#offcanvasEditBasicInfo" onclick="loadUserOnboardingData()">
                            ...
                            <div class="row g-4">
                                <!-- NAME PLATES -->
                                <div class="col-md-6">
                                    <div class="p-3 h-100 rounded-4" style="background: #F8FAFC; border: 1px solid #E2E8F0; transition: all 0.3s ease;">
                                        <div class="d-flex align-items-center">
                                ...
                                <!-- MARITAL & BLOOD -->
                                <div class="col-md-6">
                                    <div class="p-3 h-100 rounded-4" style="background: rgba(239, 68, 68, 0.04); border: 1px solid rgba(239, 68, 68, 0.1);">
                                        <div class="d-flex align-items-center">
                                            <div class="bg-white rounded-circle p-2 me-3 shadow-sm d-flex align-items-center justify-content-center" style="width: 44px; height: 44px;">
                                ...
                                <div class="col-md-6">
                                    <div class="p-3 h-100 rounded-4" style="background: rgba(34, 197, 94, 0.04); border: 1px solid rgba(34, 197, 94, 0.1);">
                                        <div class="d-flex align-items-center">
                                            <div class="bg-white rounded-circle p-2 me-3 shadow-sm d-flex align-items-center justify-content-center" style="width: 44px; height: 44px;">
                                ...
                                <!-- PARENTS -->
                                <div class="col-md-6">
                                    <div class="p-3 h-100 rounded-4" style="background: #F8FAFC; border: 1px solid #E2E8F0;">
                                        <div class="d-flex align-items-center">
                                            <div class="bg-white rounded-circle p-2 me-3 shadow-sm d-flex align-items-center justify-content-center" style="width: 44px; height: 44px;">
                                ...
                                <div class="col-md-6">
                                    <div class="p-3 h-100 rounded-4" style="background: rgba(37, 99, 235, 0.04); border: 1px solid rgba(37, 99, 235, 0.1);">
                                        <div class="d-flex align-items-center">
                                            <div class="bg-white rounded-circle p-2 me-3 shadow-sm d-flex align-items-center justify-content-center" style="width: 44px; height: 44px;">
                                                <i class="bx bx-user-pin text-primary fs-4"></i>
                                            </div>
                                            <div>
                                                <p class="mb-1 text-muted smallest fw-bold text-uppercase" style="font-size: 0.65rem;">Spouse Name</p>
                                                <p class="mb-0 fw-bold text-dark fs-6">{{ $user->spouse_name ?? 'N/A' }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="p-3 h-100 rounded-4" style="background: #F8FAFC; border: 1px solid #E2E8F0;">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <p class="mb-1 text-muted smallest fw-bold text-uppercase" style="font-size: 0.65rem;">No. of Children</p>
                                                <p class="mb-0 fw-bold text-dark fs-6">{{ $user->no_of_children ?? '0' }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card-body p-5">
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                ...
                                <div class="d-flex gap-2">
                                    <button class="btn btn-hitech px-4 rounded-pill shadow-sm" data-bs-toggle="modal" data-bs-target="#offcanvasEditWorkInfo" onclick="loadSelectList()">
                                        <i class="bx bx-edit-alt me-1"></i> Update Details
                                    </button>
                                </div>
                            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="emp-field-box">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <p class="mb-0 text-muted small fw-bold text-uppercase" style="font-size: 0.65rem; letter-spacing: 0.05em;">Department</p>
                                                <p class="mb-0 fw-bold text-dark fs-6">{{ $user->department?->name ?? 'N/A' }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="emp-field-box">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <p class="mb-0 text-muted small fw-bold text-uppercase" style="font-size: 0.65rem; letter-spacing: 0.05em;">Role</p>
                                                <p class="mb-0 fw-bold text-dark fs-6">{{ $user->getRoleNames()->first() ?? 'Employee' }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="emp-field-box">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <p class="mb-0 text-muted small fw-bold text-uppercase" style="font-size: 0.65rem; letter-spacing: 0.05em;">Reporting To</p>
                                                <p class="mb-0 fw-bold text-dark fs-6">{{ $user->reportingTo?->getFullName() ?? 'N/A' }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="emp-field-box">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <p class="mb-0 text-muted small fw-bold text-uppercase" style="font-size: 0.65rem; letter-spacing: 0.05em;">Leave Policy Profile</p>
                                                <p class="mb-0 fw-bold text-dark fs-6">
                                                    @if($user->leavePolicyProfile)
                                                        <span class="badge bg-label-info">{{ $user->leavePolicyProfile->name }}</span>
                                                    @else
                                ...
                                <div class="col-md-4">
                                    <div class="emp-field-box">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <p class="mb-0 text-muted small fw-bold text-uppercase" style="font-size: 0.65rem; letter-spacing: 0.05em;">Date of Joining</p>
                                ...
                                <div class="col-md-4">
                                    <div class="emp-field-box">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <p class="mb-0 text-muted small fw-bold text-uppercase" style="font-size: 0.65rem; letter-spacing: 0.05em;">Attendance Type</p>
                                ...
                                <div class="col-md-4">
                                    <div class="emp-field-box">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <p class="mb-0 text-muted small fw-bold text-uppercase" style="font-size: 0.65rem; letter-spacing: 0.05em;">Biometric ID</p>
                    ...
                    <div class="card mb-4 emp-card">
                        <div class="card-body p-5">
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                ...
                                <button class="btn btn-hitech-primary px-4 rounded-pill shadow-sm d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#modalManualLeaveCredit">
                                        ...
                                        <tbody>
                                            @foreach($leaveBalances as $bal)
                                                <tr>
                                                    <td class="ps-4 py-3">
                                                        <div class="d-flex align-items-center">
                                                            <div class="bg-label-primary rounded p-1 me-2"><i class="bx bx-calendar-event"></i></div>
                                                            <span class="fw-bold text-dark">{{ $bal->leaveType->name ?? 'Unknown (' . ($bal->leave_type_id ?? 'N/A') . ')' }}</span>
                                                        </div>
                                                    </td>
                                                    <td class="py-3 text-center fw-bold">{{ number_format($bal->balance, 1) }}</td>
                                                    <td class="py-3 text-center text-danger">{{ number_format($bal->used, 1) }}</td>
                                                    <td class="pe-4 py-3 text-end"><span class="badge bg-label-success">{{ number_format($bal->balance - $bal->used, 1) }}</span></td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                        ...
                        <div class="card-body p-5">
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    <button class="btn btn-hitech-secondary btn-sm px-3 rounded-pill shadow-sm" data-bs-toggle="modal" data-bs-target="#modalAllotDevice">
                                ...
                                <div class="table-responsive rounded-3 border" style="background: #fff;">
                                    <table class="table table-hover mb-0 align-middle">
                                        <thead style="background-color: #F8FAFC; border-bottom: 1px solid #E2E8F0;">
                                            <tr>
                                                <th class="ps-4 py-3 text-muted fw-bold" style="font-size: 0.7rem; text-transform: uppercase;">Asset (Brand / Model)</th>
                                                <th class="py-3 text-muted fw-bold" style="font-size: 0.7rem; text-transform: uppercase;">Asset Code / ID</th>
                                                <th class="py-3 text-muted fw-bold" style="font-size: 0.7rem; text-transform: uppercase;">Category / Type</th>
                    ...
                    <div class="card mb-4 emp-card shadow-sm border-0">
                        <div class="card-body p-4">
                            <div class="d-flex align-items-center mb-4">
                                <div class="hitech-icon-wrap me-3" style="background: rgba(108, 117, 125, 0.1); color: #6c757d; width: 42px; height: 42px; display: flex; align-items: center; justify-content: center; border-radius: 10px;">
                                    ...
                                    <table class="table table-hover mb-0 align-middle">
                                        <thead style="background-color: #F8FAFC;">
                                            <tr>
                                                ...
                                                <th class="py-3 text-muted fw-bold" style="font-size: 0.7rem; text-transform: uppercase;">Assigned At</th>
                                                <th class="py-3 text-muted fw-bold" style="font-size: 0.7rem; text-transform: uppercase;">Returned At</th>
                                                <th class="pe-4 py-3 text-muted fw-bold" style="font-size: 0.7rem; text-transform: uppercase;">Notes</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @foreach($assetHistory as $log)
                                                <tr>
                                                    <td class="ps-4 py-3">
                                                        <div class="fw-bold text-dark">{{ $log->asset->name ?? 'Inventory Asset' }}</div>
                                                        <div class="smallest text-muted">{{ $log->asset->asset_code ?? 'N/A' }}</div>
                                                    </td>
                                                    <td class="py-3 text-dark small">{{ $log->assigned_at ? $log->assigned_at->format('d M Y, h:i A') : 'N/A' }}</td>
                                                    <td class="py-3 small">
                                                        @if($log->returned_at)
                                                            <span class="text-success fw-bold">{{ $log->returned_at->format('d M Y, h:i A') }}</span>
                                                        @else
                                                            <span class="badge bg-label-primary px-2 py-1 rounded-pill">Currently Held</span>
                                                        @endif
                                                    </td>
                            ...
                            @else
                                <div class="text-center py-5 bg-light rounded-3" style="border: 1px dashed #ced4da;">
                                    ...
                                    <p class="text-muted small mb-0">No historical assignment logs found for this employee.</p>
                                </div>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="card mb-4 emp-card border-0">
                        <div class="card-body p-5">
                            ...
                            <div class="row g-4">
                                <!-- EMAIL & PHONE -->
                                <div class="col-md-4">
                                    <div class="emp-field-box border-dashed h-100 p-3" style="transition: all 0.3s ease; border-radius: 12px; cursor: default;">
                                ...
                                <div class="col-md-4">
                                    <div class="emp-field-box h-100 p-3" style="transition: all 0.3s ease; border-radius: 12px; cursor: default;">
                                ...
                                <div class="col-12 mt-2">
                                    <div class="card border-0 p-4" style="background: linear-gradient(135deg, #FFF5F5 0%, #FFF0F0 100%); border-radius: 16px; border-left: 4px solid #EF4444 !important;">
                                        ...
                                        <div class="row g-4">
                                            ...
                                            <div class="col-md-4">
                                                <div class="p-3 bg-white bg-opacity-50 rounded-3 border border-white">
                                                    <span class="d-block smallest text-muted mb-1 fw-bold text-uppercase">Contact Phone</span>
                                                    <strong class="text-danger fs-6 fw-extrabold">{{ $user->emergency_contact_phone ?? 'Not Provided' }}</strong>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="card-body p-5">
                            ...
                            @if ($hasBankData)
                                <div class="row g-4">
                                    <div class="col-md-6">
                                        <div class="emp-field-box">
                                            <p class="mb-1 text-muted smallest fw-bold text-uppercase" style="font-size: 0.65rem;">Beneficiary Name</p>
                                    ...
                                    <div class="col-12">
                                        <div class="p-3 rounded-4 d-flex align-items-center justify-content-between" style="background: rgba(18,116,100,0.05); border: 1px dashed rgba(18,116,100,0.2);">
                                            ...
                                            <button type="button" class="btn btn-xs btn-hitech-primary rounded-pill px-4" onclick="viewDocumentPopup('{{ $user->getChequeUrl() }}', 'Cancelled Cheque', '{{ $bank->account_number }}')">
                    ...
                    <div class="card mb-4 emp-card shadow-sm border-0" style="border-radius: 12px;">
                        <div class="card-body p-5">
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                ...
                                <button class="btn btn-hitech-primary px-4 rounded-pill shadow-sm" data-bs-toggle="modal" data-bs-target="#offcanvasEditCompInfo">
                            ...
                            <div class="row g-3">
                                <div class="col-md-3">
                                    <div class="emp-field-box p-3 rounded-hitech h-100" style="background: #fff; border: 1px solid #eef2f6;">
                    ...
                    <div class="card mb-4 emp-card shadow-sm border-0" style="border-radius: 12px;">
                        <div class="card-body p-5">
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                ...
                                <button class="btn btn-hitech-secondary px-4 rounded-pill shadow-sm" data-bs-toggle="modal" data-bs-target="#offcanvasPayrollAdjustment" id="addPayrollAdjustment">
                            ...
                            @if ($user->payrollAdjustments->count() > 0)
                                ...
                                @foreach ($user->payrollAdjustments as $adjustment)
                                    <div class="col-md-6">
                                        <div class="d-flex align-items-center justify-content-between p-3 rounded-4 hitech-adjustment-card" style="background-color: #F8FAFC; border: 1px solid #F1F5F9; cursor: pointer; transition: all 0.3s ease;" onclick='editAdjustment({!! json_encode($adjustment) !!})' data-bs-toggle="modal" data-bs-target="#offcanvasPayrollAdjustment">
                                            <div class="d-flex align-items-center">
                    ...
                    <div class="card mb-4 emp-card">
                        <div class="card-body p-5">
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                ...
                                <button class="btn btn-hitech-primary rounded-pill px-4 shadow-sm" data-bs-toggle="modal" data-bs-target="#modalAddUserDocument" onclick="setDocModal('Other Document', '')">
                            ...
                            <div class="row g-3">
                                @foreach($mandatoryDocs as $doc)
                                    @php
                                        ...
                                        // 1. Check User Model Columns (Aadhar/PAN numbers)
                                        if ($doc['key'] && $user->{$doc['key']}) {
                                            $isSubmitted = true;
                                            $docNumber = (string) $user->{$doc['key']};
                                        }

                                        // 2. Check Onboarding Files (Aadhar, PAN, Marksheets)
                                        ...
                                        // 3. Fallback to formal Document Requests (Admin generated/requested)
                                    ...
                                    <div class="col-md-6">
                                        <div class="p-3 rounded-3 d-flex align-items-center justify-content-between" style="background-color: #F8FAFC; border: 1px solid #E2E8F0;">
                                            ...
                                            <div class="d-flex gap-2">
                                                @if($isSubmitted)
                                                    @if($docFileUrl)
                                                        <a href="javascript:void(0)" class="btn btn-hitech-secondary btn-xs rounded-pill px-3" style="font-size: 0.65rem;" onclick="viewDocumentPopup('{{ $docFileUrl }}', '{{ $doc['name'] }}', '{{ $docNumber }}')"><i class="bx bx-show me-1"></i>View File</a>
                                                    @elseif($docNumber && $docNumber !== 'N/A')
                                                        <a href="javascript:void(0)" class="btn btn-hitech-secondary btn-xs rounded-pill px-3" style="font-size: 0.65rem;" onclick="viewDocumentNumber('{{ $doc['name'] }}', '{{ $docNumber }}')"><i class="bx bx-show me-1"></i>View No.</a>
                                                    @endif
                        ...
                        <div class="card-body p-5">
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                <div class="d-flex align-items-center">
                                    ...
                                    <h6 class="mb-0 fw-bold fs-5" style="color: #1E293B;">Key Result Areas (KRAs)</h6>
                                </div>
                                <div class="d-flex gap-2">
                                    @if(auth()->user()->hasRole(['admin', 'Admin', 'hr', 'manager', 'super_admin']) || auth()->user()->can('user-edit'))
                                        <button class="btn btn-hitech px-4 rounded-pill shadow-sm" data-bs-toggle="modal" data-bs-target="#modalAddKpi" onclick="openAddKpi()">
                            ...
                            <div class="table-responsive rounded-3 border" style="background:#fff;">
                                <table class="table table-hover table-borderless mb-0 align-middle">
                                    <thead style="background:#F8FAFC;border-bottom:1px solid #E2E8F0;">
                                        <tr>
                                            <th class="ps-4 text-muted fw-bold py-3" style="font-size:0.75rem;text-transform:uppercase;">#</th>
                                            <th class="text-muted fw-bold py-3" style="font-size:0.75rem;text-transform:uppercase;">KRA Focus & Objectives</th>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar avatar-sm me-3" style="width:38px;height:38px;">
                                                            <span class="avatar-initial rounded-circle bg-label-primary fw-bold" style="font-size:0.85rem;">{{ substr(getMetric($task->description), 0, 2) }}</span>
                                                        </div>
                                                        <div>
                                                            <h6 class="mb-0 fw-bold text-dark" style="font-size:0.9rem;">{{ getMetric($task->description) }}</h6>
                                                            <small class="text-muted d-block text-truncate" style="max-width:250px;">{{ \Illuminate\Support\Str::limit($task->description, 50) }}</small>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="text-dark small">{{ $task->expiry_date ? $task->expiry_date->format('d M, Y') : 'N/A' }}</td>
                                                <td>
                                                    <span class="badge rounded-pill fw-bold px-3 py-2" style="background:#E0F2FE;color:#0284C7;font-size:0.70rem;">
                                                        {{ strtoupper($task->status->value) }}
                                                    </span>
                                                </td>
                                                <td class="pe-4 text-end">
                                                    <div class="d-flex align-items-center justify-content-end gap-2">
                                                        <button class="btn btn-sm btn-icon rounded-circle btn-hitech-secondary" title="View" onclick="editKpi({{ $task->id }}, '{{ getMetric($task->description) }}', 'KRA', 'Standard', {{ $task->target_amount }}, '{{ $task->incentive_type->value }}', '{{ addslashes($task->description) }}')">
                                                            <i class="bx bx-show-alt"></i>
                                                        </button>
                                                        @if(auth()->user()->can('user-edit') || auth()->user()->hasRole('hr'))
                                                            <button class="btn btn-sm btn-icon rounded-circle btn-hitech-alert" title="Delete" onclick="deleteKpi({{ $task->id }})">
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="5" class="text-center py-5">
                                                    ...
                                                    <h6 class="mt-3 text-muted fw-medium">No Key Result Areas (KRAs) defined for this employee.</h6>
                                                </td>
                                            </tr>
                                        @endforelse
                                    </tbody>
                        ...
                        <div class="card-body p-5">
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                <div class="d-flex align-items-center">
                                    ...
                                    <h6 class="mb-0 fw-bold fs-5" style="color: #1E293B;">Strategic Performance (KPIs)</h6>
                                </div>
                            ...
                            <div class="row g-4 mb-4">
                                <div class="col-md-3">
                                    <div class="emp-field-box text-center h-100 p-4">
                                        ...
                                        <h3 class="fw-extrabold mb-0" style="color: #127464;">{{ count($user->salesTargets) }}</h3>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="emp-field-box text-center h-100 p-4">
                                        <p class="text-muted small fw-bold text-uppercase mb-2">Completed</p>
                                        <h3 class="fw-extrabold mb-0 text-success">{{ $user->salesTargets->where('status', 'completed')->count() }}</h3>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="emp-field-box text-center h-100 p-4">
                                        <p class="text-muted small fw-bold text-uppercase mb-2">In Progress</p>
                                        <h3 class="fw-extrabold mb-0 text-warning">{{ $user->salesTargets->where('status', 'in_progress')->count() }}</h3>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="emp-field-box text-center h-100 p-4">
                            ...
                            @if(auth()->user()->can('user-edit') || auth()->user()->hasRole('hr'))
                                <button class="btn btn-hitech-secondary px-4 rounded-pill shadow-sm" data-bs-toggle="modal" data-bs-target="#modalAddTask" onclick="resetKraModal()">
                            ...
                            <div class="table-responsive rounded-3 border" style="background:#fff;">
                                <table class="table table-hover table-borderless mb-0 align-middle">
                                    <thead style="background:#F8FAFC;border-bottom:1px solid #E2E8F0;">
                                        <tr>
                                            <th class="ps-4 text-muted fw-bold py-3" style="font-size:0.75rem;text-transform:uppercase;">#</th>
                                            <th class="text-muted fw-bold py-3" style="font-size:0.75rem;text-transform:uppercase;">KPI Target</th>
                                            <th class="text-muted fw-bold py-3" style="font-size:0.75rem;text-transform:uppercase;">Type</th>
                                            <th class="text-muted fw-bold py-3" style="font-size:0.75rem;text-transform:uppercase;">Goal</th>
                                            <th class="text-muted fw-bold py-3" style="font-size:0.75rem;text-transform:uppercase;">Status</th>
                                            <th class="pe-4 text-end text-muted fw-bold py-3" style="font-size:0.75rem;text-transform:uppercase;">Actions</th>
                                        </tr>
                                    </thead>
                                        ...
                                        @forelse($kpiPerformance as $index => $target)
                                            <tr style="border-bottom:1px solid #F1F5F9;">
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar avatar-sm me-3" style="width:38px;height:38px;">
                                                            <span class="avatar-initial rounded-circle bg-label-info fw-bold" style="font-size:0.85rem;">{{ substr(getMetric($target->description), 0, 2) }}</span>
                                                        </div>
                                                        <div>
                                                            <h6 class="mb-0 fw-bold text-dark" style="font-size:0.9rem;">{{ getMetric($target->description) }}</h6>
                                                            <small class="text-muted d-block text-truncate" style="max-width:200px;">{{ \Illuminate\Support\Str::limit($target->description, 30) }}</small>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="text-dark small">{{ ucfirst($target->incentive_type->value) }}</td>
                                                <td class="text-dark small">{{ $settings->currency_symbol }}{{ number_format($target->target_amount, 2) }}</td>
                                                <td>
                                                    <span class="badge bg-label-success rounded-pill fw-bold px-3 py-2" style="font-size:0.70rem;">{{ strtoupper($target->status->value) }}</span>
                                                </td>
                                                <td class="pe-4 text-end">
                                                    <div class="d-flex align-items-center justify-content-end gap-2">
                                                        <button class="btn btn-sm btn-icon rounded-circle btn-hitech-secondary" title="View/Edit" onclick="editKpi({{ $target->id }}, '{{ getMetric($target->description) }}', 'KPI', 'Standard', {{ $target->target_amount }}, '{{ $target->incentive_type->value }}', '{{ addslashes($target->description) }}')">
                                                            <i class="bx bx-edit"></i>
                                                        </button>
                                                        <button class="btn btn-sm btn-icon rounded-circle btn-hitech-alert" title="Delete" onclick="deleteKpi({{ $target->id }})">
                                                            <i class="bx bx-trash"></i>
                                                        </button>
                                                    </div>
                                                </td>
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="6" class="text-center py-5">
                                                    <i class="bx bx-bar-chart-alt text-muted" style="font-size:3rem;opacity:0.3;"></i>
                                                    <h6 class="mt-3 text-muted fw-medium">No Strategic Performance targets defined.</h6>
                                                </td>
                                            </tr>
                                        @endforelse
                                    </tbody>
                            ...
                            <div class="timeline ps-4 border-start border-2 border-light py-2">
                                ...
                                <div class="timeline-item position-relative mb-5 pb-3">
                                    <div class="timeline-dot position-absolute rounded-circle shadow-sm" 
                                         style="width: 14px; height: 14px; background: #127464; border: 3px solid #fff; left: -31px; top: 0;"></div>
                                    <div class="d-flex justify-content-between align-items-center mb-1">
                                        <h6 class="mb-0 fw-bold text-dark fs-6">{{ ucfirst($log->event) }} {{ class_basename($log->auditable_type) }}</h6>
                                        <small class="text-muted fw-medium small">{{ $log->created_at->diffForHumans() }}</small>
                                    </div>
                                    <p class="mb-0 text-muted smallest">Performed by: {{ $log->user ? $log->user->getFullName() : 'System' }}</p>
                                    @if(!empty($log->old_values) || !empty($log->new_values))
                                        <div class="mt-2 text-warning smallest bg-light p-2 rounded-3" style="font-family: monospace;">
                                ...
                                <div class="text-center py-5">
                                    <i class="bx bx-ghost text-muted mb-3" style="font-size: 3rem; opacity: 0.3;"></i>
                                    <p class="text-muted mb-0 fw-medium">No activity records found for this entry.</p>
                                </div>
                                @endforelse
                            </div>
                        </div>
            ...
            <div class="mobile-tab-navigation d-md-none mt-4 pb-4">
                <div class="card border-0 shadow-sm" style="background: rgba(255, 255, 255, 0.9); backdrop-filter: blur(10px); border-radius: 20px;">
                    <div class="card-body p-3 d-flex justify-content-between gap-3">
                        ...
                        <button class="btn btn-hitech-primary rounded-pill flex-fill py-2 fw-bold" onclick="navigateTabs('next')">
                    ...
                    <div class="modal-body modal-body-hitech">
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" id="docModalNumber" name="documentNumber" class="form-control form-control-hitech" placeholder="Enter ID number" required>
                            </div>
                            <div class="col-12">
            ...
            <div class="modal-content modal-content-hitech">
                ...
                <form id="addTaskForm">
                    ...
                    <div class="modal-body modal-body-hitech">
                        <div class="row g-4">
                            <div class="col-12">
                                <label class="form-label-hitech" id="taskTitleLabel">KRA Title / Objective <span class="text-danger">*</span></label>
                                <input type="text" name="title" id="modalTaskTitle" class="form-control form-control-hitech" placeholder="e.g. Operational Excellence" required>
                            </div>
                            <div class="col-12">
                                <label class="form-label-hitech">Core Value & Scope</label>
                                <textarea name="description" id="modalTaskDescription" class="form-control form-control-hitech" rows="3" placeholder="Enter key responsibilities..."></textarea>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label-hitech">Due Date</label>
                                <input type="date" name="due_date" id="modalTaskDueDate" class="form-control form-control-hitech" min="{{ date('Y-m-d') }}">
                            </div>
                            <div class="col-md-6">
                    ...
                    <div class="modal-footer border-0 px-4 pb-4 d-flex justify-content-end gap-3">
                        <button type="button" class="btn btn-hitech-modal-cancel" data-bs-dismiss="modal">Cancel</button>
                        <button type="submit" class="btn btn-hitech-modal-submit">Publish KRA <i class="bx bx-check-circle ms-1"></i></button>
                    </div>
                </form>
            </div>
        </div>
                ...
                <div class="modal-body modal-body-hitech">
                    <form action="{{ route('employees.allotDevice') }}" method="POST" id="allotDeviceForm">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <label class="form-label-hitech" for="allotDeviceId">Asset Code / ID <span class="badge bg-label-info ms-2 small">Auto-Generated</span></label>
                                <input type="text" name="deviceId" id="allotDeviceId" class="form-control form-control-hitech bg-light" placeholder="Automatically generated based on Category..." readonly>
                            </div>

                            <div class="col-md-6">
                                <label class="form-label-hitech" for="allotDeviceBrand">Asset Name <span class="text-muted small">(optional)</span></label>
                            ...
                            <div class="col-md-6">
                                <label class="form-label-hitech" for="allotModelNumber">Model Number <span class="text-muted small">(optional)</span></label>
                                <input type="text" name="modelNumber" id="allotModelNumber" class="form-control form-control-hitech" placeholder="e.g. Latitude 5420">
                            </div>

                            <div class="col-md-6">
                                <label class="form-label-hitech" for="allotSerialNumber">Serial Number <span class="text-muted small">(optional)</span></label>
                            ...
                            <div class="col-md-6">
                                <label class="form-label-hitech" for="allotServiceTag">Service Tag <span class="text-muted small">(optional)</span></label>
                                <input type="text" name="serviceTag" id="allotServiceTag" class="form-control form-control-hitech" placeholder="e.g. TAG-XYZ9">
                            </div>

                            <div class="col-md-6">
                                <label class="form-label-hitech" for="allotWarrantyExpiry">Warranty Expiry <span class="text-muted small">(optional)</span></label>
                                <input type="date" name="warrantyExpiry" id="allotWarrantyExpiry" class="form-control form-control-hitech" min="{{ date('Y-m-d') }}">
                            </div>
                        ...
                        <div id="stepperReviewOnboarding" class="bs-stepper shadow-none border-0 m-0">
                            ...
                            <div class="onboarding-review-content bs-stepper-content p-5">
                                <form id="formReviewOnboarding" class="p-0 m-0">
                                    ...
                                    <div id="step-personal" class="content animate__animated animate__fadeIn">
                                        <div class="review-section-card">
                                            <div class="review-section-header">
                                                ...
                                                <div class="hitech-toggle-pill group-personal" data-section="personal">
                                                    <div class="hitech-toggle-opt opt-approve active" data-value="approve" onclick="toggleSectionStatus(this, 'personal', true)">
                                                        <i class="bx bx-check-circle me-1"></i> APPROVED
                                                    </div>
                                                    <div class="hitech-toggle-opt opt-flag" data-value="flag" onclick="toggleSectionStatus(this, 'personal', false)">
                                        ...
                                        <div class="review-section-card">
                                            <div class="review-section-header">
                                                ...
                                                <div class="hitech-toggle-pill group-contact" data-section="contact">
                                                    <div class="hitech-toggle-opt opt-approve active" data-value="approve" onclick="toggleSectionStatus(this, 'contact', true)">
                                                        <i class="bx bx-check-circle me-1"></i> APPROVED
                                                    </div>
                                                    <div class="hitech-toggle-opt opt-flag" data-value="flag" onclick="toggleSectionStatus(this, 'contact', false)">
                                                        <i class="bx bx-x-circle me-1"></i> FLAGGED
                                                    </div>
                                        ...
                                        <div class="review-section-card">
                                            <div class="review-section-header">
                                                ...
                                                <div class="hitech-toggle-pill group-banking" data-section="banking">
                                                    <div class="hitech-toggle-opt opt-approve active" data-value="approve" onclick="toggleSectionStatus(this, 'banking', true)">
                                                        <i class="bx bx-check-circle me-1"></i> APPROVED
                                                    </div>
                                                    <div class="hitech-toggle-opt opt-flag" data-value="flag" onclick="toggleSectionStatus(this, 'banking', false)">
                                                        <i class="bx bx-x-circle me-1"></i> FLAGGED
                                                    </div>
                                        ...
                                        <div class="review-section-card">
                                            <div class="review-section-header">
                                                ...
                                                <div class="hitech-toggle-pill group-documents" data-section="documents">
                                                    <div class="hitech-toggle-opt opt-approve active" data-value="approve" onclick="toggleSectionStatus(this, 'documents', true)">
                                                        <i class="bx bx-check-circle me-1"></i> APPROVED
                                                    </div>
                                                    <div class="hitech-toggle-opt opt-flag" data-value="flag" onclick="toggleSectionStatus(this, 'documents', false)">
                                                        <i class="bx bx-x-circle me-1"></i> FLAGGED
                                                    </div>
...
@section('page-script')
    <script>
        ...
        $(document).on('submit', '#addKpiForm', function(e) {
            ...
            const url = '{{ route('employees.storeSalesTarget') }}';
        ...
        // Manual Review Logic (Simplified - No Stepper)
        // Initialize Onboarding Review Flow
        document.addEventListener('DOMContentLoaded', function() {
            var stepperEl = document.getElementById('stepperReviewOnboarding');
            if (stepperEl) {
                var stepperReview = new Stepper(stepperEl, {
                    linear: false,
                    animation: true
                });
                ...
                stepperEl.addEventListener('show.bs-stepper', function (event) {
                    ...
                    // Next vs Action button visibility
                    if (index === 4) { // Final Step (Decision)
                        $('.btn-next').hide();
            ...
            $(document).on('click', '.hitech-toggle-opt', function() {
                ...
                // Toggle active state in the UI
                group.find('.hitech-toggle-opt').removeClass('active');
                btn.addClass('active');
                
                if (val === 'flag') {
                    checkbox.prop('checked', true);
                    remarksBox.stop().slideDown(300);
                    remarksBox.find('textarea').focus();
                } else {
                    checkbox.prop('checked', false);
                    remarksBox.stop().slideUp(250);
                }
                
                // Refresh decision states if we're on the last step
                updateDecisionButtonsState();
            });

            // State management for final decision step
            window.updateDecisionButtonsState = function() {
                if (!stepperEl || !stepperReview || stepperReview._currentIndex !== 4) return;
                ...
                if (anyFlagged) {
                    ...
                    lockInfo.html(`
                        <div class="text-center p-3 rounded-4" style="background: #fff1f2; border: 1px dashed #ef4444;">
                            <i class="bx bxs-error-circle fs-1 text-danger mb-2"></i>
                            <div class="fw-bold text-danger">Corrections Required</div>
                            <div class="small text-muted">${flaggedCount} section(s) marked for revision.</div>
                        </div>
                    `);
                } else {
                    ...
                    lockInfo.html(`
                        <div class="text-center p-3 rounded-4" style="background: #f0fdf4; border: 1px dashed #22c55e;">
                            <i class="bx bxs-check-shield fs-1 text-success mb-2"></i>
                            <div class="fw-bold text-success">Verification Perfect</div>
                            <div class="small text-muted">All sections approved. Ready for activation.</div>
                        </div>
                    `);
                }
            };
            ...
            // Modal reset
            $('#modalReviewOnboarding').on('hidden.bs.modal', function () {
                if(stepperReview) stepperReview.to(1);
            });
        });

        // DOCUMENT VIEW POPUP HANDLER (Premium Dark Mode)
        window.viewDocumentPopup = function(url, title) {
            const modalEl = document.getElementById('modalViewDocument');
            const container = document.getElementById('docViewContainer');
            const titleEl = document.getElementById('docViewModalTitle');
            const downloadBtn = document.getElementById('docViewDownloadBtn');
            ...
            container.innerHTML = `
                <div class="text-center text-white py-5">
                    ...
                    <div class="fw-bold opacity-75">Decrypting Secure Document...</div>
                </div>
            `;
            ...
            setTimeout(() => {
                if (isImage) {
                    container.innerHTML = `<img src="${url}" class="img-fluid rounded shadow-lg" style="max-height: 75vh; object-fit: contain;">`;
                } else {
        ...
        window.submitReviewModification = function() {
            ...
            if (!feedback || feedback.trim().length < 10) {
                Swal.fire({
                    html: `
                        <div class="text-center">
                            <i class="bx bx-error fs-1 text-danger mb-3"></i>
                            <h4 class="fw-bold mb-0">Detailed Feedback Required</h4>
                            <p class="text-muted mt-2">Please provide clear instructions (min 10 chars) for the employee to correct the flagged sections.</p>
                        </div>
                    `,
                    customClass: { popup: 'rounded-4 shadow border-0', confirmButton: 'btn btn-hitech-pill-primary px-5' },
                    buttonsStyling: false
                });
                return;
            }
            ...
            Swal.fire({
                html: `
                    <div class="text-center">
                        <div class="mx-auto bg-label-danger rounded-circle d-flex align-items-center justify-content-center mb-3" style="width: 70px; height: 70px;">
                            <i class="bx bx-paper-plane text-danger fs-1"></i>
                        </div>
                        <h3 class="fw-bold text-dark mb-0">Send for Correction?</h3>
                        <p class="text-muted mt-2">The employee will be notified to update the flagged sections before final approval.</p>
                    </div>
                `,
                showCancelButton: true,
                ...
                customClass: {
                    popup: 'rounded-4 shadow-lg border-0',
                    confirmButton: 'btn btn-hitech-pill-danger me-3 px-4',
                    cancelButton: 'btn btn-hitech-pill-secondary px-4'
                },
                buttonsStyling: false
            }).then((result) => {
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ route('employees.onboarding.resubmit', $user->id) }}",
                        method: 'POST',
                        data: formData,
                        processData: false,
                        contentType: false,
                        success: function(response) {
                            if (response.success) {
                                Swal.fire({ 
                                    html: `
                                        <div class="text-center">
                                            <div class="mx-auto bg-label-success rounded-circle d-flex align-items-center justify-content-center mb-3" style="width: 60px; height: 60px;">
                                                <i class="bx bx-check text-success fs-1"></i>
                                            </div>
                                            <h4 class="fw-bold text-dark mb-0">Sent!</h4>
                                            <p class="text-muted mt-2">Modification request has been sent.</p>
                                        </div>
                                    `,
                        ...
                        error: function(xhr) {
                            ...
                            if (xhr.status === 422) {
                                message = Object.values(xhr.responseJSON.errors).map(e => e.join('<br>')).join('<br>');
                            }
                            Swal.fire({
                                html: `
                                    <div class="text-center">
                                        <div class="mx-auto bg-label-danger rounded-circle d-flex align-items-center justify-content-center mb-3" style="width: 50px; height: 50px;">
                                            <i class="bx bx-error text-danger fs-2"></i>
                                        </div>
                                        <h4 class="fw-bold text-dark mb-0">Submission Error</h4>
                                        <p class="text-danger mt-2 small">${message}</p>
                                    </div>
                                `,
                                customClass: { popup: 'rounded-4 shadow border-0', confirmButton: 'btn btn-hitech-pill-danger px-4' },
                                buttonsStyling: false
                            });
                        }
                    });
        ...
        // ── KPI/KRA Modal Control ──────────────────────────────────────────
        window.openAddKpi = function() {
            $('#addTaskForm')[0].reset();
            $('#modalKpiId').val('');
            $('#addKpiForm')[0].reset();
            $('.modal-title-hitech').text('Define Performance KPI/KRA');
            $('#modalAddKpi').modal('show');
        };

        window.editKpi = function(id, metric, category, grade, amount, type, desc) {
            $('#modalKpiId').val(id);
            $('#modalKpiMetric').val(metric);
            $('#modalKpiCategory').val(category);
            $('#modalKpiGrade').val(grade);
            $('#modalKpiGoal').val(amount);
            $('#modalKpiType').val(type);
            $('#modalKpiDescription').val(desc);
            $('.modal-title-hitech').text('Update Performance KPI/KRA');
            $('#modalAddKpi').modal('show');
        };

        // ── KPI Functions ──────────────────────────────────────────────────────
        window.updateKpiStatus = function(id, status) {
            const labels = {
                'in_progress': 'In Progress', 'under_review': 'Under Review',
                'achieved': 'Achieved', 'missed': 'Missed', 'cancelled': 'Cancelled'
            };
            Swal.fire({
                title: 'Update KPI Status?',
                text: `Set this target to "${labels[status] || status}"?`,
                icon: 'question',
                showCancelButton: true,
                confirmButtonText: 'Yes, Update',
                customClass: { confirmButton: 'btn btn-primary me-3', cancelButton: 'btn btn-label-secondary' },
                ...
                if (res.isConfirmed) {
                    $.post(`${baseUrl}employees/updateKpiStatus/${id}`, { _token: '{{ csrf_token() }}', status: status }, function(resp) {
                        if (resp.success) {
        ...
        window.deleteKpi = function(id) {
            Swal.fire({
                ...
                showCancelButton: true,
                confirmButtonText: 'Yes, Delete',
                customClass: { confirmButton: 'btn btn-hitech-alert rounded-pill px-4 fw-bold shadow-sm', cancelButton: 'btn btn-hitech-secondary rounded-pill px-4 fw-bold ms-3' },
                buttonsStyling: false
            }).then(res => {
                if (res.isConfirmed) {
                    $.ajax({
                        url: `${baseUrl}employees/destroySalesTarget/${id}`,
                        type: 'DELETE',
                        data: { _token: '{{ csrf_token() }}' },
                        success: function(resp) {
                            if (resp.success) {
                        ...
                        error: () => Swal.fire('Error', 'Failed to delete KPI', 'error')
                    });
                }
            });
        };

        window.openSelfAssessment = function(id) {
            Swal.fire({
                title: 'Submit Self-Assessment',
                input: 'textarea',
                inputPlaceholder: 'Describe your progress, achievements, and challenges...',
                ...
                preConfirm: (notes) => {
                    ...
                    return $.post(`${baseUrl}employees/submitKpiSelfAssessment/${id}`, { _token: '{{ csrf_token() }}', notes: notes })
                        .then(resp => resp)
                        .catch(xhr => { Swal.showValidationMessage(xhr.responseJSON?.message || 'Failed'); });
                }
            }).then(result => {
                if (result.isConfirmed && result.value?.success) {
                    Swal.fire({ icon: 'success', title: 'Submitted!', text: 'Your self-assessment has been recorded.', timer: 1500, showConfirmButton: false });
                    setTimeout(() => location.reload(), 1500);
                }
            });
        };

        window.approveOnboarding = function(userId) {            Swal.fire({
                html: `
                    <div class="text-center">
                        <div class="mx-auto bg-label-success rounded-circle d-flex align-items-center justify-content-center mb-3" style="width: 70px; height: 70px;">
                            <i class="bx bxs-check-shield text-success fs-1"></i>
                        </div>
                        <h3 class="fw-bold text-dark mb-0">Approve Profile?</h3>
                        <p class="text-muted mt-2">This will activate the employee and grant full dashboard access.</p>
                    </div>
                `,
                showCancelButton: true,
                ...
                customClass: {
                    popup: 'rounded-4 shadow-lg border-0',
                    confirmButton: 'btn btn-hitech-pill-success me-3 px-4',
                    cancelButton: 'btn btn-hitech-pill-secondary px-4'
                },
                buttonsStyling: false
            }).then((result) => {
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ route('employees.onboarding.approve', $user->id) }}",
                        method: 'POST',
                        data: { _token: '{{ csrf_token() }}' },
                        success: function(response) {
                            if (response.success) {
                                Swal.fire({ icon: 'success', title: 'Activated!', text: 'Employee successfully activated.', timer: 2000, showConfirmButton: false });
                                setTimeout(() => location.reload(), 2000);
                            } else {
                                Swal.fire('Error', response.message || 'Action failed', 'error');
                            }
    ...
    <!-- Unified Document Viewer Modal (Global Hitech Style) -->
