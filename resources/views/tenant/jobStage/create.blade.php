<div class="modal-content modal-content-hitech">
    <div class="modal-header modal-header-hitech">
        <div class="d-flex align-items-center">
            ...
            <h5 class="modal-title modal-title-hitech">Create New Job Stage</h5>
        </div>
        ...
        <div class="modal-body modal-body-hitech">
            <div class="row g-4">
                <div class="col-md-12">
                    ...
                    <input class="form-control form-control-hitech" name="title" type="text" placeholder="Enter stage title (e.g. Technical Interview)" required>
                </div>
            </div>
        </div>
        <div class="modal-footer border-0 px-4 pb-4">
            <button type="button" class="btn btn-label-secondary" data-bs-dismiss="modal">Cancel</button>
            <button type="submit" class="btn btn-hitech px-4">Create Stage</button>
        </div>
    </form>
</div>
