...
<div class="layout-full-width animate__animated animate__fadeIn">
    ...
    <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-6 mx-4 py-2">
        <h3 class="fw-extrabold mb-0 text-dark">Designation Management</h3>
        <button type="button" class="btn btn-hitech-primary shadow-sm rounded-pill px-5 add-new-designation" data-bs-toggle="modal"
                data-bs-target="#modalAddOrUpdateDesignation">
            <i class="bx bx-plus-circle me-1"></i>Add Designation
        </button>
    </div>
            ...
            <div class="card-body p-sm-5 p-4">
                <div class="d-flex flex-wrap align-items-center gap-3">
                    ...
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <button type="button" class="btn btn-hitech-primary px-4 shadow-sm" id="btnExportDesignations">
    ...
    <div class="px-4">
        <div class="hitech-card-white p-0 overflow-hidden">
            <div class="card-datatable table-responsive">
                <table class="datatables-designations table m-0 shadow-none border-top">
                    <thead>
                        <tr>
                            <th>@lang('')</th>
                            <th>@lang('Id')</th>
