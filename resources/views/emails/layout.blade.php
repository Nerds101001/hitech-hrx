...
<head>
  ...
  <title>@yield('title', 'Hi Tech Group')</title>
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .info-label { font-size: 11px; font-weight: 700; color: #94a3b8; text-transform: uppercase; letter-spacing: 1px; }
...
<div class="email-wrapper">
  <div class="email-header">
    ...
    <div>
      <div class="header-badge">@yield('badge', 'Notification')</div>
      <h1 class="header-title">@yield('header_title')</h1>
    </div>
  </div>

  <div class="email-body">
    <p class="greeting">@yield('greeting', 'Hello,')</p>
    @yield('content')
  </div>
