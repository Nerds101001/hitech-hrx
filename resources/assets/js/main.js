...
// Global AJAX Setup for CSRF and 419 Errors
if (typeof jQuery !== 'undefined') {
  $(document).ajaxError(function (event, jqXHR, ajaxSettings, thrownError) {
    if (jqXHR.status === 419) {
      ...
      Swal.fire({
        title: 'Access Denied',
        text: 'You do not have permission to perform this action. If you are an Admin, please ensure your role name matches precisely (Admin/admin).',
        icon: 'error',
        customClass: {
