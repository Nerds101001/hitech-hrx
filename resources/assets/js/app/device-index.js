        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            if (full['user_profile_image']) {
              ...
              initials = full['user_initial'];
              profileOutput = '<span class="avatar-initial rounded-circle bg-label-hitech">' + initials + '</span>';
            }
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              `<a href="javascript:;" class="text-hitech device-status-details me-2" data-id="${full['id']}" data-bs-toggle="offcanvas" data-bs-target="#offcanvasDeviceStatusDetails" title="View"><i class="bx bx-show fs-4"></i></a>` +
              `<a href="javascript:;" class="text-danger delete-record" data-id="${full['id']}" title="Delete"><i class="bx bx-trash fs-4"></i></a>` +
              '</div>'
            );
          }
        }
