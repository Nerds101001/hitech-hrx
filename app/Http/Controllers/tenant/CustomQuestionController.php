...
class CustomQuestionController extends Controller
{
    ...
    public function index()
    {
        if(Auth::user()->can('Manage Custom Question'))
        {
            ...
            return view('tenant.customQuestion.index', compact('questions'));
        }
        else
        {
    ...
    public function create()
    {
        ...
        return view('tenant.customQuestion.create', compact('is_required'));
    }
    ...
    {
        $is_required = CustomQuestion::$is_required;
        return view('tenant.customQuestion.edit', compact('customQuestion','is_required'));
    }
